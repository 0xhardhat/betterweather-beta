      ...
      <div className="flex flex-col items-center lg:flex-row lg:justify-around lg:items-center lg:gap-28 mt-28">
        <div className="flex flex-col lg:items-start items-center lg:w-[400px] gap-6">
          ...
          <div className="flex flex-row gap-3">
            <Button className="h-12 px-[40px] py-[17px] bg-gradient-to-r from-[#6DDABA] to-[#39997D] text-[#F9FCFF] text-sm rounded-lg">
              About Us
            </Button>
            <Button className="h-12 px-[40px] py-[17px] bg-[#191B26] text-[#515670] text-sm rounded-lg">
              How To Use It?
            </Button>
          </div>
        </div>
